...
DAMAGE_SPELLS = {
 ...
 ('', [25, 29]),
 ('', [26, 30]),
 ('', [27, 31])], is_linked=(1, 'All or Nothing'), casting={'ap': [2, 2, 2], 'per_turn': [3, 3, 3], 'per_target': [2, 2, 2], 'crit': [5, 5, 5]}, spell_id=12881),
 ...
 ('', [7])], is_linked=(1, 'Tribute'), casting={'ap': [2, 2, 2], 'per_turn': [3, 3, 3], 'per_target': [1, 1, 1], 'crit': [10, 10, 10]}, spell_id=13672),
        ...
        Spell('Journey', [40, 107, 174], Effects(
            ...
            [['23-25', '29-32', '36-40'],
             ...
             ['23-25', '29-32', '36-40']],
            [EARTH, FIRE, WATER, AIR],
        ), aggregates=[('', [0]), ('', [1]), ('', [2]), ('', [3])], casting={'ap': [3, 3, 3], 'cooldown': [2, 2, 2], 'crit': [20, 20, 20]}, spell_id=13683),
 ...
 ('Stack 4', [4])], is_linked=(2, 'Marrow Bone'), casting={'ap': [5, 5], 'per_turn': [1, 1], 'crit': [25, 25]}, spell_id=13793),
        ...
        ), aggregates=[('', [0]), ('', [1]), ('', [2, 3]), ('', [4, 5, 6])], is_linked=(2, 'Amarok'), casting={'ap': [4, 4], 'per_turn': [1, 1], 'crit': [5, 5]}, spell_id=13758),
    ...
    'Pandawa': [
        Spell('Hangover', [1, 66, 132], Effects(
            ...
            [['17-19', '22-25', '29-32'],
             ...
             ['21-23', '28-31', '39-42']],
            [EARTH, EARTH, EARTH],
        ), aggregates=[('', [0]), ('', [1]), ('', [2])], is_linked=(1, 'Fiery Breath'), casting={'ap': [3, 3, 3], 'per_turn': [3, 3, 3], 'per_target': [2, 2, 2], 'crit': [10, 10, 10]}, spell_id=12803),
 ...
 ('', [9])], stacks=4, is_linked=(1, 'Distillation'), casting={'ap': [2, 2, 2], 'per_turn': [3, 3, 3], 'crit': [10, 10, 10]}, spell_id=12781),
        ...
        Spell('Explosive Flask', [65, 131, 198], Effects(
            ...
            [FIRE, FIRE],
        ), aggregates=[('', [0]), ('', [1])], is_linked=(1, 'Pandatak'), casting={'ap': [2, 2, 2], 'per_turn': [1, 1, 1], 'crit': [10, 10, 10]}, spell_id=12796),
        ...
        Spell('Melancholy', [80, 147], Effects(
            ...
            [WATER, WATER],
        ), aggregates=[('', [0]), ('', [1])], is_linked=(1, 'Pandjiu'), casting={'ap': [4, 4], 'per_turn': [2, 2], 'crit': [15, 15]}, spell_id=12794),
 ...
 ('', [9])], stacks=4, is_linked=(2, 'Explosive Palm'), casting={'ap': [4, 4], 'per_turn': [1, 1], 'crit': [20, 20]}, spell_id=12815),
        ...
        Spell('Alcoholic Breath', [170], Effects(
            ...
            [['34-38'], ['40-44']],
            [AIR, AIR],
        ), aggregates=[('', [0]), ('', [1])], is_linked=(2, 'Eviction'), casting={'ap': [3], 'per_turn': [2], 'crit': [10]}, spell_id=12784),
        Spell('Pandatak', [175], Effects(
            [['38-42'], ['46-50']],
            [['46-50'], ['54-58']],
            [EARTH, EARTH],
        ), aggregates=[('', [0]), ('', [1])], is_linked=(2, 'Explosive Flask'), casting={'ap': [4], 'per_turn': [2], 'crit': [15]}, spell_id=12797),
