...
DAMAGE_SPELLS = {
 ...
 ('Stack 4', [4])], is_linked=(2, 'Explosive Arrow'), casting={'ap': [4], 'per_turn': [2], 'crit': [15]}, spell_id=32457),
    ...
    'Ecaflip': [
        ...
        ), aggregates=[('', [0, 2, 5, 6])], is_linked=(1, 'Playful Claw'), casting={'ap': [2, 2, 2], 'per_turn': [3, 3, 3], 'per_target': [2, 2, 2], 'crit': [5, 5, 5]}, spell_id=12846),
 ...
 ('', [9]),
 ('Stack 5', [10]),
 ('', [11])], stacks=5, is_linked=(2, 'Gangsterdom'), casting={'ap': [4, 4], 'per_turn': [3, 3], 'per_target': [2, 2], 'crit': [20, 20]}, spell_id=12932),
