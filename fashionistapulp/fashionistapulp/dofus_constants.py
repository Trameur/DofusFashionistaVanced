...
DAMAGE_SPELLS = {
 ...
 ('Stack 4', [4])], stacks=4, is_linked=(2, 'Heads or Tails'), casting={'ap': [4, 4], 'per_turn': [1, 1], 'crit': [20, 20]}, spell_id=12878),
        Spell('Misfortune', [125, 192], Effects(
            ...
            [WATER, WATER],
            steals=[True, False],
        ), is_linked=(2, 'Jass'), casting={'ap': [5, 5], 'per_turn': [1, 1], 'crit': [20, 20]}, spell_id=12880),
        Spell('Nerve', [135], Effects(
            [['44-48'], ['26-28']],
            [['58'], ['33']],
            [AIR, AIR],
            steals=[True, False],
        ), is_linked=(2, 'Luck'), casting={'ap': [5], 'per_turn': [1], 'crit': [20]}, spell_id=12882),
        Spell('Fate of Ecaflip', [145], Effects(
            [['42-46'], ['25-27']],
            [['55'], ['31']],
            [EARTH, EARTH],
            steals=[True, False],
        ), is_linked=(2, 'Blakjak'), casting={'ap': [5], 'per_turn': [1], 'crit': [20]}, spell_id=12859),
        Spell('Peril', [155], Effects(
            [['43-47'], ['26-28']],
            [['56'], ['33']],
            [FIRE, FIRE],
            steals=[True, False],
        ), is_linked=(2, 'Belote'), casting={'ap': [5], 'per_turn': [1], 'crit': [20]}, spell_id=14311),
 ...
 ('Stack 4', [4])], is_linked=(1, 'Water Clock'), casting={'ap': [4, 4, 4], 'per_turn': [3, 3, 3], 'per_target': [2, 2, 2], 'crit': [15, 15, 15]}, spell_id=13256),
        ...
        Spell('Harmpit', [180], Effects(
            ...
            [['15-17'], ['36-38']],
            [AIR, AIR],
        ), is_linked=(2, 'Petrification'), casting={'ap': [2], 'per_turn': [2], 'per_target': [1], 'crit': [5]}, spell_id=14651),
