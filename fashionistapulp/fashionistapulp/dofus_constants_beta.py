...
DAMAGE_SPELLS = {
    ...
    'Cra': [
        Spell('[!] Flèche de Recul', [25], Effects(
            [['15-18']],
            [['19-23']],
            [AIR],
        ), is_linked=(1, '[!] Flèche Assaillante')),
        Spell('[!] Flèche Cinglante', [1], Effects(
            [['25-28']],
            [['30-34']],
            [AIR],
        ), is_linked=(1, '[!] Flèche Éclatante')),
        Spell('[!] Flèche de Dispersion', [40], Effects(
            [['21-24']],
            [['25-29']],
            [AIR],
        ), is_linked=(1, '[!] Flèches Enflammées')),
        Spell('[!] Flèche Perforante', [190], Effects(
            [['29-32'], ['35-38']],
            [['35-38'], ['42-46']],
            [AIR, AIR],
        ), is_linked=(2, '[!] Flèche Persécutrice')),
        Spell('[!] Pluie de Flèches', [160], Effects(
            [['21-23']],
            [['25-28']],
            [AIR],
        ), is_linked=(2, '[!] Œil de Taupe')),
        Spell('[!] Flèche Boomerang', [130], Effects(
            [['31-35'], ['31-35']],
            [['37-42'], ['37-42']],
            [AIR, AIR],
            steals=[False, True],
        ), is_linked=(2, "[!] Flèche d'Abolition")),
        Spell('[!] Flèche Persécutrice', [80], Effects(
            [['34-38'], ['34-38']],
            [['41-46'], ['41-46']],
            [AIR, AIR],
            steals=[True, False],
        ), is_linked=(1, '[!] Flèche Perforante')),
        Spell('[!] Flèche Glacée', [1], Effects(
            [['21-24']],
            [['25-29']],
            [WATER],
        ), is_linked=(1, 'Plaguing Arrow')),
        Spell("[!] Flèche d'Immobilisation", [30], Effects(
 ...
 ('Stack 4', [4])], stacks=4, is_linked=(1, '[!] Flèche Tyrannique')),
        Spell('[!] Œil de Taupe', [50], Effects(
            [['19-22']],
            [['23-26']],
            [WATER],
            steals=[True],
        ), is_linked=(1, '[!] Pluie de Flèches')),
        Spell("[!] Flèche d'Expiation", [75], Effects(
            [['35-37']],
            [['42-44']],
            [WATER],
        ), is_linked=(1, '[!] Flèche de Rédemption')),
        Spell('[!] Flèche Ralentissante', [125], Effects(
            [['32-34']],
            [['38-41']],
            [WATER],
        ...
        Spell('[!] Flèche de Rédemption', [185], Effects(
            ...
            [['35-38']],
            [WATER],
        ), is_linked=(2, "[!] Flèche d'Expiation")),
        Spell('[!] Flèche de Barrage', [1], Effects(
            [['24-27']],
            [['29-32']],
            [FIRE],
        ), is_linked=(1, '[!] Flèche Massacrante')),
        Spell('[!] Flèche Détonante', [15], Effects(
            [['14-17'], ['14-17']],
            [['18-21'], ['18-21']],
            [FIRE, FIRE],
            steals=[True, False],
        ), is_linked=(1, '[!] Flèche Ralentissante')),
        Spell('[!] Flèche Explosive', [45], Effects(
            [['30-34']],
            [['36-41']],
            [FIRE],
        ), is_linked=(1, '[!] Carreaux Destructeurs')),
        Spell('[!] Flèche Dévorante', [85], Effects(
            [['11-13'],
             ['11-13'],
             ['23-27'],
             ['34-38'],
            ...
            steals=[False, False, False, False, False, True, True, True, True, True, True, True],
        ...
        Spell('[!] Flèche Éclatante', [95], Effects(
            [['22-25']],
            [['26-30']],
            [FIRE],
        ...
        Spell('[!] Flèche Fulminante', [195], Effects(
            ...
            [['34-37']],
            [FIRE],
        ), stacks=3, is_linked=(2, '[!] Flèche Dévorante')),
        Spell("[!] Flèche d'Abolition", [20], Effects(
            [['13-15'], ['18-21']],
            [['16-18'], ['22-25']],
            [EARTH, EARTH],
        ), is_linked=(1, '[!] Flèche Boomerang')),
        Spell('[!] Œil pour Œil', [55], Effects(
            [['27-29']],
            [['32-34']],
            [EARTH],
            steals=[True],
        ), is_linked=(1, '[!] Flèche Paralysante')),
        Spell('[!] Flèche Vagabonde', [1], Effects(
            [['27-30']],
            [['32-36']],
            [EARTH],
        ), is_linked=(1, '[!] Flèche Évasive')),
        Spell('[!] Flèche Punitive', [70], Effects(
            [['30-34']],
            [['36-41']],
            [EARTH],
        ), is_linked=(1, '[!] Flèche du Jugement')),
        Spell('[!] Flèche Massacrante', [105], Effects(
            [['35-39']],
            [['42-47']],
            [EARTH],
        ...
        Spell('[!] Carreaux Destructeurs', [155], Effects(
            [['38-42']],
            [['46-50']],
            [EARTH],
        ), is_linked=(2, '[!] Flèche Explosive')),
        Spell('[!] Flèche du Jugement', [180], Effects(
            [['36-40'], ['25-27']],
            [['43-48'], ['30-32']],
            [EARTH, EARTH],
        ), is_linked=(2, '[!] Flèche Punitive')),
        Spell('[!] Acuité Absolue', [90], Effects(
            [['100']],
            None,
            ['buff_pow'],
        )),
        ...
        Spell('[!] Flèche Évasive', [110], Effects(
            [['26-29']],
            [['31-35']],
            [WATER],
        ), is_linked=(2, '[!] Flèche Vagabonde')),
        Spell('Plaguing Arrow', [100], Effects(
            [['17-19']],
            [['20-23']],
            [AIR],
