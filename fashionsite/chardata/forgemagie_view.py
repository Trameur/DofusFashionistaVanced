...
LOCALIZED_UI = {
    'en': {
        ...
        'version_note_modern': 'Values for the current PC game (Dofus 3 and Dofus 3 Beta).',
        ...
        'version_note_touch': 'Values for Dofus Touch, forked from Dofus 2.14: wisdom weighs 1 per point against the 3 it weighs on PC, and the client has no reflect, no trap and no per-attack-type percentage runes.',
    ...
    'fr': {
        ...
        'version_note_modern': 'Valeurs pour le jeu PC actuel (Dofus 3 et Dofus 3 Bêta).',
        ...
        'version_note_touch': 'Valeurs pour Dofus Touch, issu de la 2.14 : la sagesse pèse 1 par point contre 3 sur PC, et le client n’a ni renvoi, ni piège, ni runes de dommages en % par type d’attaque.',
    ...
    'es': {
        ...
        'version_note_modern': 'Valores para el juego de PC actual (Dofus 3 y Dofus 3 Beta).',
        ...
        'version_note_touch': 'Valores para Dofus Touch, derivado de la 2.14: la sabiduría pesa 1 por punto frente a los 3 del PC, y el cliente no tiene reenvío, ni trampas, ni runas de daño en % por tipo de ataque.',
    ...
    'pt': {
        ...
        'version_note_modern': 'Valores para o jogo de PC atual (Dofus 3 e Dofus 3 Beta).',
        ...
        'version_note_touch': 'Valores para o Dofus Touch, derivado da 2.14: a sabedoria pesa 1 por ponto contra os 3 do PC, e o cliente não tem reenvio, nem armadilhas, nem runas de dano em % por tipo de ataque.',
    ...
    'de': {
        ...
        'version_note_modern': 'Werte für das aktuelle PC-Spiel (Dofus 3 und Dofus 3 Beta).',
        ...
        'version_note_touch': 'Werte für Dofus Touch, abgezweigt von Dofus 2.14: Weisheit wiegt 1 pro Punkt gegenüber 3 am PC, und der Client hat weder Schadensreflexion noch Fallen noch prozentuale Schadensrunen je Angriffsart.',
