...
LOCALIZED_UI = {
    ...
    'de': {
        ...
        'sim_reset': 'Sitzung zuruecksetzen',
        'sim_undo': 'Letzten Wurf rueckgaengig machen',
        'sim_sink': 'Aktuelle Senke (Reliquat)',
        'sim_throws': 'Wuerfe',
        'sim_runes_used': 'Verbrauchte Runen',
        'sim_suggested': 'Naechste empfohlene Rune',
        'sim_rune_label': 'Rune',
        ...
        'sim_no_target': 'Setze Ziele ueber deinen Wuerfen, um Vorschlaege zu erhalten.',
        'sim_chance': 'Geschaetzte Erfolgschance',
        'sim_disclaimer': 'Simulierte Wahrscheinlichkeiten und Verluste sind grobe Community-Schaetzungen; das echte Spiel kann abweichen.',
        'sim_now': 'Aktuell',
        'sim_target': 'Ziel',
        'sim_remaining': 'Verbleibend',
        'sim_sink_gain': 'Senke',
        'sim_sacrifice': 'Opferwurf - wirf kleine Runen, damit der unerwuenschte Wert faellt und sein Gewicht als Senke gespeichert wird',
        'sim_sacrifice_hint': 'Tipp: Die Senke ist leer. Senke das Ziel eines entbehrlichen Werts (z. B. AP auf 0), damit er faellt und die Senke fuellt, bevor du teure Runen setzt.',
        'sim_profit_title': 'Rentabilitaet',
        ...
        'sim_profit': 'Gewinn',
        'sim_unit_price': 'Stueckpreis',
        'quality_title': 'Wurfqualitaet',
    ...
    js_config = {
        ...
        't': {
            key: t[key] for key in (
                ...
                'ref_no_rune',
                'sim_sink', 'sim_throws', 'sim_runes_used', 'sim_suggested',
