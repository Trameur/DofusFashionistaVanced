...
<h2>Die Multiplikatoren: Leistung, Schaden, Kritisch</h2>
<p>Leistung hebt deinen gesamten Elementarschaden auf einmal und verdient fast immer ein hohes Gewicht. Fixer Schaden (+Schaden) ist am stärksten bei Multi-Treffer-Zaubern mit niedriger Basis; %-Schaden skaliert mit großen Treffern. Die Prozent-Schadenswerte sind eine Dofus-2-Neuerung: sie tauchen auf Dofus 3, der Beta und Dofus 2 auf, aber nicht auf Touch oder Retro, wo du stattdessen auf Leistung und festen Schaden setzt. Retro benennt die Leistung wie sein eigenes Spiel, % Schaden, und das ist die Zeile, die du dort gewichtest. Kritische Trefferrate ist super, <em>wenn</em> deine Kritischen wirklich einen spürbaren Bonus draufpacken: schau den Zauber an, bevor du ihr hinterherjagst, und beachte, dass <a href="/guides/critical-hits/">wie kritische Treffer funktionieren, von deiner Version abhängt</a>.</p>
