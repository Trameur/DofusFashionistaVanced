...
ORDER = ['getting-started', 'how-it-works', 'stats-explained', 'tuning-your-weights', 'game-modes', 'reading-an-item', 'understanding-your-solution', 'mono-vs-multi-element', 'gearing-up', 'comparing-builds', 'versions-explained']
