...
LOCALIZED_UI = {
    'en': {
        ...
        'text_hint': 'Paste the item name and its stats, one per line, or type them. Nothing is downloaded and nothing leaves your browser.',
    ...
    'fr': {
        ...
        'text_hint': 'Collez le nom de l’objet et ses stats, une par ligne, ou tapez-les. Rien n’est téléchargé et rien ne sort de votre navigateur.',
    ...
    'es': {
        ...
        'text_hint': 'Pegue el nombre del objeto y sus características, una por línea, o escríbalas. No se descarga nada y nada sale de su navegador.',
    ...
    'pt': {
        ...
        'text_hint': 'Cole o nome do item e os seus atributos, um por linha, ou escreva-os. Nada é baixado e nada sai do seu navegador.',
    ...
    'de': {
        ...
        'text_hint': 'Fügen Sie den Namen des Gegenstands und seine Werte ein, einen pro Zeile, oder tippen Sie sie ab. Es wird nichts heruntergeladen und nichts verlässt Ihren Browser.',
