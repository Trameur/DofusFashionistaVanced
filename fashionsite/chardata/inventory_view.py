...
LOCALIZED_UI = {
    'en': {
        ...
        'ocr_whole_build': 'Reading a whole build rather than one item? The text import takes one tooltip screenshot per piece.',
        ...
        'text_button': 'Add from text',
        'text_hint': 'Paste the item name and its stats, one per line, or type them. Nothing is downloaded; the item name is sent to this site so we can find it in our catalogue.',
        'text_read': 'Read this text',
        'text_placeholder': 'Item name\n201 Vitality\n15 Strength',
    ...
    'fr': {
        ...
        'ocr_whole_build': 'Vous lisez un build entier plutôt qu’un objet ? L’import de texte prend une capture d’infobulle par pièce.',
        ...
        'text_button': 'Ajouter depuis du texte',
        'text_hint': 'Collez le nom de l’objet et ses stats, une par ligne, ou tapez-les. Rien n’est téléchargé ; le nom de l’objet est envoyé à ce site pour le retrouver dans notre catalogue.',
        'text_read': 'Lire ce texte',
        'text_placeholder': 'Nom de l’objet\n201 Vitalité\n15 Force',
    ...
    'es': {
        ...
        'ocr_whole_build': '¿Lees un build entero y no un solo objeto? La importación de texto acepta una captura de descripción por pieza.',
        ...
        'text_button': 'Añadir desde texto',
        'text_hint': 'Pegue el nombre del objeto y sus características, una por línea, o escríbalas. No se descarga nada; el nombre del objeto se envía a este sitio para localizarlo en nuestro catálogo.',
        'text_read': 'Leer este texto',
        'text_placeholder': 'Nombre del objeto\n201 Vitalidad\n15 Fuerza',
    ...
    'pt': {
        ...
        'text_button': 'Adicionar a partir de texto',
        'text_hint': 'Cole o nome do item e os seus atributos, um por linha, ou escreva-os. Nada é baixado; o nome do item é enviado a este site para o encontrarmos no nosso catálogo.',
        'text_read': 'Ler este texto',
        'text_placeholder': 'Nome do item\n201 Vitalidade\n15 Força',
    ...
    'de': {
        ...
        'ocr_whole_build': 'Einen ganzen Build statt eines Gegenstands lesen? Der Textimport nimmt einen Tooltip-Screenshot pro Teil.',
        ...
        'text_button': 'Aus Text hinzufügen',
        'text_hint': 'Fügen Sie den Namen des Gegenstands und seine Werte ein, einen pro Zeile, oder tippen Sie sie ab. Es wird nichts heruntergeladen; der Name des Gegenstands wird an diese Seite geschickt, damit wir ihn in unserem Katalog finden.',
        'text_read': 'Diesen Text lesen',
        'text_placeholder': 'Name des Gegenstands\n201 Vitalität\n15 Stärke',
