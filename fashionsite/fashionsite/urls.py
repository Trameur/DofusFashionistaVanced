...
urlpatterns = [
    ...
    re_path(r'^workshop/stock/reset/$', workshop_view.workshop_reset_stock, name='workshop_reset_stock'),
    re_path(r'^workshop/addset/(?P<set_id>\d+)/$', workshop_view.workshop_add_set, name='workshop_add_set'),
    re_path(r'^workshop/craft/(?P<workshop_item_id>\d+)/$', workshop_view.craft_workshop_item, name='workshop_craft'),
    re_path(r'^workshop/uncraft/(?P<workshop_item_id>\d+)/$', workshop_view.uncraft_workshop_item, name='workshop_uncraft'),
